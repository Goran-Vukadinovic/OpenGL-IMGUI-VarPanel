...
class MonoType;
class MonoString;
class MonoReflectionType;

template<typename RetType, typename... Args>
void mono_add_internal_call(const char* name, RetType(*func)(Args...))
{
...
#define HZ_ADD_INTERNAL_CALL(Name) mono_add_internal_call("Hazel.InternalCalls::" #Name, Name)
	...
	static bool Entity_HasComponent(UUID entityID, MonoReflectionType* componentType)
	{
		...
		MonoType* managedType = nullptr;// mono_reflection_type_get_type(componentType);
	...
	static void RegisterComponent()
	{
		([]()
		{
			...
			MonoType* managedType = nullptr;// mono_reflection_type_from_name(managedTypename.data(), ScriptEngine::GetCoreAssemblyImage());
			if (!managedType)
			{
